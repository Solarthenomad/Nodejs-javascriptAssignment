...
<body>
    <?php
    $conncect = mysqli_connect('', 'root', 'password', 'db_board ') or die("connect failed");
    $number = $_GET['number'];
    ...
    ?>
       <form method="POST" action="modify_action.php">
          <table style = "padding-top:50px" align = center width = auto border = 0 cellpacing = 3>
            <tr>
            ...
            <tr>
                <td style="background-color:white">
                    <table class="table2">
                        ...
                        <tr>
                            <td>내용</td>
                            <td><textarea name = content cols= 75 rows = 15><?= $content ?></td>
                        </tr>
